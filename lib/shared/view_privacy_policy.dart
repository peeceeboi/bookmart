...
class ViewPrivacyPolicy extends StatefulWidget {
  @override
  _ViewPrivacyPolicyState createState() => _ViewPrivacyPolicyState();

  final currentTheme;
  bool fromLogin = false;
  ViewPrivacyPolicy({this.currentTheme, this.fromLogin});

}

class _ViewPrivacyPolicyState extends State<ViewPrivacyPolicy> {
            ...
            Expanded(child: ListView(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text(privacyPolicy, style: TextStyle(color: secondaryColor, fontFamily: 'Poppins Regular'),),
                )
              ],
            ))
          ],
