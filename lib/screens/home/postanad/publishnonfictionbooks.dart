...
class PublishNonFiction extends StatefulWidget {
  @override
  _PublishNonFictionState createState() => _PublishNonFictionState();

  String currentTheme;
  PostAdModel currentWorkingModel;
  final Function goToFinalDetails;

  PublishNonFiction({this.currentTheme, this.currentWorkingModel, this.goToFinalDetails});
}

class _PublishNonFictionState extends State<PublishNonFiction> {
  @override
   ...
   nonFictionalGenreList.sort((a, b) => a.toString().compareTo(b.toString()));
    ...
    void prepFinalDetails(int index) {
      if (index == -1) {
        ...
        widget.currentWorkingModel.subCategory = nonFictionalGenreList[index];
      }
          ...
          children: [
            ...
            Expanded(
                child: ListView.builder(
                    itemCount: nonFictionalGenreList.length,
